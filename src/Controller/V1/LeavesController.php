...
class LeavesController extends \WP_REST_Controller {
	 ...
	 * @var string
	 */
	protected $rest_base = 'leaves';

	/**
	 * Constructor.
	 *
	 * @param LeaveService $entity_service
	 */
	public function __construct( protected LeaveService $entity_service ) {
