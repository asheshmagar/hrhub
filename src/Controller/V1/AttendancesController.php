...
use HRHub\Repository\AttendanceRepository;
use HRHub\Service\AttendanceService;

class AttendancesController extends \WP_REST_Controller {
	 ...
	 * @var string
	 */
	protected $rest_base = 'attendances';

	/**
	 * Constructor.
	 *
	 * @param AttendanceService $entity_service
	 */
	public function __construct( protected AttendanceService $entity_service ) {
